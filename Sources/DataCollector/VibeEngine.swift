...
enum VibeSystem {
    ...
    static func evaluate(
        ...
        let calendar = Calendar.current  // Note: This is relatively expensive, but evaluate is not hot-loop in this context.
        // Optimization: We could pass isWeekend in args, but for now calculate it.
